...
class TestPopulation(unittest.TestCase):
    def test_create_population_dict(self):
        from JST_analysis.io_package.load_population import create_population_dict, load_excel_pop
    ...
    def test_aggregate_populations(self):
        from JST_analysis.io_package.load_population import load_excel_pop, create_population_dict, clean_dataframes, aggregate_populations
